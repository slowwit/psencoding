...
$fil = $fileEvent.SourceEventArgs.NewEvent.TargetInstance.PartComponent -replace '\\\\34M93TT\\root\\cimv2:CIM_DataFile\.Name\="(.*)"','$1'
 
Get-FileEncoding $fil
Convert-FileEncoding -Include *.sql -Path $fil -Encoding UTF8
Get-FileEncoding $fil
